...
public class CodeUtil {
    ...
    private static final int DEFAULT_DOT_NUMBER = 10;//圆点
    ...
    private static final int DEFAULT_DOT_WIDTH = 15;
    private String code;
...
//        canvas.drawColor(Color.rgb(DEFAULT_COLOR,DEFAULT_COLOR,DEFAULT_COLOR));
        ...
        for (int i = 0; i < DEFAULT_DOT_NUMBER; i++) {
    ...
    private void drawDot(Canvas canvas, Paint paint){
        ...
        int width = random.nextInt(DEFAULT_DOT_WIDTH);
        rectF.top = random.nextInt(DEFAULT_HEIGHT);
        rectF.bottom = rectF.top + width;
        rectF.left = random.nextInt(DEFAULT_WIDTH);
